        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-6">
          ...
          <div className="md:col-span-1 lg:col-span-1">
            ...
            <div className="mt-4">
              ...
              <div className="flex space-x-4 mb-4">
                ...
                <a href="https://linkedin.com" className="text-gray-400 hover:text-blue-600" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/upgrade" className="hover:text-blue-500 transition-colors">Try Premium</Link></li>
